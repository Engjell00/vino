       ...
       alt="Logo du site Vino">
             ...
             <div class="mdl-layout--large-screen-only mdl-layout__header-row">
              ...
              <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
                <a href="profil.html" class="mdl-layout__tab">Mon profil</a>
                <a href="index.php?requete=cellierParUsager" class="mdl-layout__tab">Mes celliers</a>
                <a href="inscription.html" class="mdl-layout__tab">Inscription</a>
                
                <a href="connexion.html" class="mdl-layout__tab">Connexion</a>
